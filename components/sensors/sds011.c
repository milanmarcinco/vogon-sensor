...
#define SENSORS_PARTICULATE_WARM_UP 5
#define SENSORS_PARTICULATE_MEASUREMENT_BULK_SIZE 1
#define SENSORS_PARTICULATE_MEASUREMENT_BULK_SLEEP 3
...
void sds011_task() {
	...
	vTaskDelay(pdMS_TO_TICKS(SENSORS_PARTICULATE_WARM_UP * 1000));
	...
	while (true) {
		...
		for (int i = 0; i < SENSORS_PARTICULATE_MEASUREMENT_BULK_SIZE; i++) {
			uint16_t pm25 = 0;
			uint16_t pm10 = 0;
			...
			vTaskDelay(pdMS_TO_TICKS(SENSORS_PARTICULATE_MEASUREMENT_BULK_SLEEP * 1000));
		}

		uint16_t pm25 = pm25_total / SENSORS_PARTICULATE_MEASUREMENT_BULK_SIZE;
		uint16_t pm10 = pm10_total / SENSORS_PARTICULATE_MEASUREMENT_BULK_SIZE;
